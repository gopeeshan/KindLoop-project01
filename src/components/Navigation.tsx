        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-border bg-background">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#home" className="block px-3 py-2 text-muted-foreground hover:text-primary">
                Home
              </a>
              <a href="#browse" className="block px-3 py-2 text-muted-foreground hover:text-primary">
                Browse Items
              </a>
              <a href="#how-it-works" className="block px-3 py-2 text-muted-foreground hover:text-primary">
                How It Works
              </a>
